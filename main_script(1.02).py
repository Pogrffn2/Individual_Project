...
headers = {
    ...
    'accept': 'application/json, text/plain, */*',
    'accept-language': 'ru_RU, ru',
    'authorization': 'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJodHRwczpcL1wvbXNhcGkuaXRzdGVwLm9yZyIsImlhdCI6MTY5OTk2MDYzMiwiYXVkIjoxLCJleHAiOjE2OTk5NjQyMzIsImFwaUFwcGxpY2F0aW9uSWQiOjEsImFwaVVzZXJUeXBlSWQiOjEsInVzZXJJZCI6MjcwLCJpZENpdHkiOjQxMn0.Wm2q0iJtlrRZGrQqb1wBCX1Rkeu-s98pa7Q6uvpj9q0',
    'origin': 'https://journal.top-academy.ru',
    'referer': 'https://journal.top-academy.ru/',
